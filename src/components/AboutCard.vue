<template>
    <div>
    <b-card style="width: 1000px; height: 2300 px; " 
    overlay
    title="About skAIrocKet"
    class="mb-2"
    img-src = "@/assets/pictures/AIrocket_trans.png"
    >
    
    <b-card-text style="font-size:26 px; text-align: left;">
